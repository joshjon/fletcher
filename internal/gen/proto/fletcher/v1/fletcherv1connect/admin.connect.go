...
const (
	...
	AdminServiceName = "fletcher.v1.AdminService"
)
...
const (
	...
	AdminServiceHealthProcedure = "/fletcher.v1.AdminService/Health"
)

// AdminServiceClient is a client for the fletcher.v1.AdminService service.
...
// NewAdminServiceClient constructs a client for the fletcher.v1.AdminService service. By default,
...
func NewAdminServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AdminServiceClient {
	...
	adminServiceMethods := v1.File_fletcher_v1_admin_proto.Services().ByName("AdminService").Methods()
...
// Health calls fletcher.v1.AdminService.Health.
...
// AdminServiceHandler is an implementation of the fletcher.v1.AdminService service.
...
func NewAdminServiceHandler(svc AdminServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/fletcher.v1.AdminService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAdminServiceHandler) Health(context.Context, *connect.Request[v1.HealthRequest]) (*connect.Response[v1.HealthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fletcher.v1.AdminService.Health is not implemented"))
}
