...
const (
	...
	EventServiceName = "fletcher.v1.EventService"
)
...
const (
	...
	// RPC.
	EventServiceWatchEventsProcedure = "/fletcher.v1.EventService/WatchEvents"
)

// EventServiceClient is a client for the fletcher.v1.EventService service.
...
// NewEventServiceClient constructs a client for the fletcher.v1.EventService service. By default,
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_fletcher_v1_events_proto.Services().ByName("EventService").Methods()
...
// WatchEvents calls fletcher.v1.EventService.WatchEvents.
...
// EventServiceHandler is an implementation of the fletcher.v1.EventService service.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/fletcher.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) WatchEvents(context.Context, *connect.Request[v1.WatchEventsRequest], *connect.ServerStream[v1.WatchEventsResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("fletcher.v1.EventService.WatchEvents is not implemented"))
}
